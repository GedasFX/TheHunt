...
namespace TheHunt.Domain.Migrations
{
    ...
    [Migration("20221231123129_Roles")]
    partial class Roles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheHunt.Domain.Models.Competition", b =>
                {
                    b.OwnsOne("TheHunt.Domain.Models.RolesRef", "Roles", b1 =>
                        {
                            b1.Property<decimal>("CompetitionChannelId")
                                .HasColumnType("numeric(20,0)");

                            b1.Property<decimal>("ParticipantRoleId")
                                .HasColumnType("numeric(20,0)")
                                .HasColumnName("role_participant");

                            b1.Property<decimal>("VerifierRoleId")
                                .HasColumnType("numeric(20,0)")
