...
namespace TheHunt.Data.Migrations
{
    ...
    [Migration("20240203193308_ItemsFeature")]
    partial class ItemsFeature
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheHunt.Data.Models.Competition", b =>
                {
                    b.OwnsOne("TheHunt.Data.Models.Features", "Features", b1 =>
                        {
                            b1.Property<ulong>("CompetitionChannelId")
                                .HasColumnType("INTEGER");

                            b1.Property<bool>("ItemsRestricted")
                                .HasColumnType("INTEGER")
                                .HasColumnName("feature_items_restricted");
